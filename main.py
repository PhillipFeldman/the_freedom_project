...
for investor_url in investor_links:
    ...
    while not guru_done:
        ...
        for row in rows:
            ...
            if percent_difference_current_price == None:
            ...
            investor_file.write(f'{name},{company},{ticker},{stock},{percent_portfolio},{shares},{reported_price},{percent_difference_current_price},{current_price},{value},{percent_activity},{percent_change_to_portfolio}\n')
        print(f'Pge {i} done')
